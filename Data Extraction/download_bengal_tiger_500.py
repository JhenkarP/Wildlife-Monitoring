"""Download a quality-filtered Bengal tiger photo set from iNaturalist."""
...
TAXON_ID = 130793
INDIA_PLACE_ID = 6681
OUTPUT_ROOT = ROOT / "data" / "training" / "images" / "bengal tiger"
...
def main() -> None:
    ...
    session.headers["User-Agent"] = "Animal-Monitoring Bengal tiger dataset collector"
            ...
            for photo in observation.get("photos") or []:
                ...
                try:
                    ...
                    manifest_rows.append({
                        ...
                        "photo_id": photo_id,
                        "taxon": observation.get("taxon", {}).get("name", "Panthera tigris tigris"),
