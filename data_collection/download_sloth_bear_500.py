"""Download a quality-filtered Sloth bear photo set from iNaturalist."""
...
TAXON_ID = 41651
INDIA_PLACE_ID = 6681
OUTPUT_ROOT = ROOT / "data" / "training" / "images" / "sloth bear"
...
def main() -> None:
    ...
    session.headers["User-Agent"] = "Animal-Monitoring Sloth bear dataset collector"
            ...
            for photo in observation.get("photos") or []:
                ...
                try:
                    ...
                    manifest_rows.append({
                        ...
                        "photo_id": photo_id,
                        "taxon": observation.get("taxon", {}).get("name", "Melursus ursinus"),
