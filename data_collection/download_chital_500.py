"""Download Chital photos observed in India from iNaturalist."""
...
TAXON_ID = 42166
INDIA_PLACE_ID = 6681
OUTPUT_ROOT = ROOT / "data" / "training" / "images" / "chital"
...
def main() -> None:
    ...
    session.headers["User-Agent"] = "Animal-Monitoring Chital India dataset collector"
            ...
            for photo in observation.get("photos") or []:
                ...
                try:
                    ...
                    manifest_rows.append({
                        ...
                        "photo_id": photo_id,
                        "taxon": observation.get("taxon", {}).get("name", "Axis axis"),
