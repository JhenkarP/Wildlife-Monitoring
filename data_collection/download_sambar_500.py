"""Download a quality-filtered Sambar photo set from iNaturalist."""
...
TAXON_ID = 75053
INDIA_PLACE_ID = 6681
OUTPUT_ROOT = ROOT / "data" / "training" / "images" / "sambar"
...
def main() -> None:
    ...
    session.headers["User-Agent"] = "Animal-Monitoring Sambar dataset collector"
            ...
            for photo in observation.get("photos") or []:
                ...
                try:
                    ...
                    manifest_rows.append({
                        ...
                        "photo_id": photo_id,
                        "taxon": observation.get("taxon", {}).get("name", "Rusa unicolor"),
